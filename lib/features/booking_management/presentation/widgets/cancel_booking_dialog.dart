...
Future<bool> confirmCancelBooking(BuildContext context, BookingSummary summary) async {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: (refund > 0 ? AppTheme.success : AppTheme.danger).withValues(alpha: 0.08),
